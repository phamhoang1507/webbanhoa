...
if ($id_dm != 0) {
    ...
    $rowPerPage = 8;
    $perRow = $page * $rowPerPage - $rowPerPage;
    $sql = "SELECT * FROM sanpham ORDER BY id_sp DESC LIMIT $perRow, $rowPerPage";
}
...
if ($id_dm == 0) {
    $list_page .= '<li class="active"><a href="index.php?page_layout=danhsachsp&id_dm=0&page='.$i.'">' . $i . '</a></li>';
}
?>
<div class="products">
