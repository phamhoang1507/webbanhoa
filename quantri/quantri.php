<?php  
    ...
    if ($_SESSION['email']=='admin@admin.vn' && $_SESSION['pass']=='123' || $_SESSION['email']=='xdieu2k2@gmail.com' && $_SESSION['pass']=='220120') {
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="quantri.php"><span>Tiệm Hoa UNETI!</span>Admin</a>
                    <ul class="user-menu">
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=donhang">
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=lienhe">
                        <span data-toggle="collapse" href="#sub-item-4"><svg class="glyph stroked two messages"><use xlink:href="#stroked-two-messages"/></svg></span> Liên hệ
                    </a>
                ...
                if(isset($_GET['page_layout'])){
                    switch ($_GET['page_layout']) {
                        ...
                        case 'thongtin': include_once'./chucnang/thanhvien/thongtin.php';
                            break;
                        case 'donhang': include_once'./chucnang/donhang/donhang.php';
                            break;
                        case 'xoadonhang': include_once'./chucnang/donhang/xoadonhang.php';
                            break;
                        case 'lienhe': include_once'./chucnang/lienhe/lienhe.php';
                            break;   
