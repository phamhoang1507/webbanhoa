                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bao_hanh" value="1-3 ngày với hoa tươi, 30-60 ngày với hoa giả" required="">
                        </div>

                        <div class="form-group">
                            <label>Đi kèm</label>
                            <input type="text" class="form-control" name="phu_kien" value="Ruy băng, dây buộc,vv" required="">
                        </div>
                        <div class="form-group">
                            <label>Tình trạng</label>
                            <input type="text" class="form-control" name="tinh_trang" value="Hoa mới 100%" required="">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="khuyen_mai" value="Mua một tặng một" required="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Các loại hoa</label>
                            <select name="id_dm" class="form-control">
                                <option value="unselect" selected>Lựa chọn loại hoa</option>
                                <?php
